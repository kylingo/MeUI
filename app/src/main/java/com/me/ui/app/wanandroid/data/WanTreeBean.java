...
/**
 * @author kylingo
 * @since 2019/05/07 13:23
 */
public class WanTreeBean implements Serializable {
    ...
    private int visible;
    private List<WanTreeBean> children;
    ...
    public List<WanTreeBean> getChildren() {
        return children;
    }

    public void setChildren(List<WanTreeBean> children) {
