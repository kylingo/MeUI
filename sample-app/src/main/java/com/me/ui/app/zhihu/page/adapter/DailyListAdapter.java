...
import com.me.ui.app.zhihu.domain.util.ImageLoaderUtils;
import com.me.ui.app.zhihu.model.entity.Daily;
import com.me.ui.app.zhihu.page.activity.ZhiHuWebActivity;
...
public class DailyListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void gotoWebView(Daily news, View v) {
        ...
        Intent intent = new Intent(v.getContext(), ZhiHuWebActivity.class);
...
//        }
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        void onClick(View v) {
            // TODO do what you want :) you can use ZhiHuWebActivity to load
